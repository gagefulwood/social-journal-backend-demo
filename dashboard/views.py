...
class DashboardView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        payload = {
            'interaction_heatmap': self._get_interaction_heatmap(
                user,
                heatmap_window,
            ),
    ...
    def _get_upcoming_events(self, user):
        return (
            ...
            .prefetch_related('participants', 'logs', 'reflections')
    ...
    def _get_activity_stats(self, user):
        ...
        return {
            'entries_total': log_count + reflection_count,
            'entries_30d': log_30d_count + reflection_30d_count,
            'entries_by_kind_30d': {
                'log': log_30d_count,
        ...
        contacts = (
            ...
            .annotate(
                last_interaction_date=Max(
                    'events_participants__event__event_timestamp'
                )
            )
